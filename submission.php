...
<html lang="en">
   ...
   <div class="container mt-5">
		<div class="row">
		   ...
		   <form   class="card-header bg-info" id="addanimals" action="submission.php"method="POST"> 
				 ...
				 <select  type="text "id="lifeexpectancy" name="lifeexpectancy">
												<option value="">select </option>
												
												<option value="0-1 year">0-1 year
												</option>
												<option value="1-5year">
												1-5year</option>
 ...
 $query= "insert into animal(name,category,image,description,lifeexpectancy)value('$name1','$category1','$image1','$description1','$lifeexpectancy')";
